...
var PageNavButtonLeft = styled(Button)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 30px;\n  height: 30px;\n  margin: 0 5px;\n\n  @media (max-width: 768px) {\n    width: 25px;\n    height: 25px;\n  }\n"], ["\n  width: 30px;\n  height: 30px;\n  margin: 0 5px;\n\n  @media (max-width: 768px) {\n    width: 25px;\n    height: 25px;\n  }\n"])));
var PageNavButtonRight = styled(PageNavButtonLeft)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  margin: 0 20px 0 5px;\n"], ["\n  margin: 0 20px 0 5px;\n"])));
var PageTag = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  color: ", ";\n  font-size: 14px;\n  text-align: left;\n\n  @media (max-width: 768px) {\n    font-size: 10px;\n  }\n"], ["\n  color: ", ";\n  font-size: 14px;\n  text-align: left;\n\n  @media (max-width: 768px) {\n    font-size: 10px;\n  }\n"])), function (props) { return props.theme.textPrimary; });
...
function PDFPagination() {
    ...
    return (React.createElement(Container, { id: "pdf-pagination" },
        React.createElement(PageNavButtonLeft, { id: "pdf-pagination-prev", onClick: function () {
                return dispatch(setDocumentCurrentPage(renderSettings.currentPage - 1));
            }, disabled: renderSettings.currentPage === 1 },
            React.createElement(PrevPDFNavIcon, { color: "#000", size: "50%" })),
        React.createElement(PageTag, { id: "pdf-pagination-info" }, "Page " + renderSettings.currentPage + "/" + renderSettings.pagesCount),
        React.createElement(PageNavButtonRight, { id: "pdf-pagination-next", onClick: function () {
                return dispatch(setDocumentCurrentPage(renderSettings.currentPage + 1));
