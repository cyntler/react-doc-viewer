...
var AppProvider = function (props) {
    ...
    var contextValue = React.useMemo(function () { return ({ state: state, dispatch: dispatch }); }, [state]);
    useEffect(function () {
    ...
    return (React.createElement(DocViewerContext.Provider, { value: contextValue }, children));
};
