...
export const setDocumentPagesCount = (
  value: number
...
export const setDocumentCurrentPage = (
  value: number
...
export const SET_DOCUMENT_ROTATION_ANGLE: string =
  "SET_DOCUMENT_ROTATION_ANGLE";
...
export const SET_DOCUMENT_RENDER_SETTINGS: string =
